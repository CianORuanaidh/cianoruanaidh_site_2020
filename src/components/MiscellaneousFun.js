            ...
            <section className="misc-fun">
                ...
                <div className="project-list">
                    ...
                    <div className="project-item swiims">
                        ...
                        <iframe onLoad={this.iframeLoaded()} src="https://open.spotify.com/embed/album/47JEvHPJldsFaw37SqVCFt?si=AgWgxB4wT0Omic7Jwdcy2w" width="300" height="80" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                        <p>Below is a video I created video for our song <em><a href="#">Hand Of Love</a></em> below.</p>
                        <iframe onLoad={this.iframeLoaded()} width="800" height="420" src="https://www.youtube.com/embed/QBJ6PaQX0T8" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    ...
                    <div className="project-item waking-west">
                        ...
                        <iframe onLoad={this.iframeLoaded} src="https://open.spotify.com/embed/album/4ZaD2NQz0KiOZpK4AMrFXV?si=hbnsWTbMQf2M_Y5QrEfhjA" width="300" height="80" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                        <p>Below is a video I created video for our song <em><a href="#">Brother</a></em>.</p>
                        <iframe onLoad={this.iframeLoaded} width="800" height="420" src="https://www.youtube.com/embed/NVTpTByq2ow" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
